...
ggsave('./10x/outs/TwoYear_Tcell_cloneSizes.png', plot = csize_plot, height = 10, width = 7)
...
TopSplitCluster
ggsave('./10x/outs/TwoYear_TopClones_clusters.png', height = 5, width = 20)
...
ggsave('./10x/outs/TwoYear_scPCR_pairedMatch.png', height = 6.5, width = 12)
...
ggsave('./10x/outs/TwoYear_bulk_matched_chains.png', height = 10, width = 22)
