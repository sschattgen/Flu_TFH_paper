...
ggsave('./10x/outs/TwoYear_Tcells_Tcell_type_enrichr.pdf', 
...
ggsave('./10x/outs/TwoYear_Tcells_Tcell_type_Tfh_only_enrichr.pdf',
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor4_time_metabolism_GSVA_HM.pdf', 
       gsva_hm_list[[1]], width = 829/72, height =  349/72, useDingbats = F)
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor5_time_metabolism_GSVA_HM.pdf', 
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_both_donors_time_metabolism_GSVA_HM.pdf', 
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor4_Tfh_type_metabolism_GSVA_HM.pdf', 
       gsva_hm_list2[[1]], width = 794/72, height =  261/72, useDingbats = F)
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor5_Tfh_type_metabolism_GSVA_HM.pdf', 
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_both_donors_Tfh_type_metabolism_GSVA_HM.pdf', 
       gsva_hm_list2[[2]], width = 794/72, height =  261/72, useDingbats = F)
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_GO_scores_umap.pdf', 
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor4_Tfh_type_GO_scores.pdf', 
       score_dist_tfh_type_d4, width = 995/72, height =  606/72, useDingbats = F)
ggsave('./10x/outs/TwoYear_Tfh_lineages_donor5_Tfh_type_GO_scores.pdf', 
