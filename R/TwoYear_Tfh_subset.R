...
ggsave('./10x/outs/TwoYear_Tcell_Tfh_lineage_cluster_freq.png',
...
write_tsv( Tfh_cl_markers, './10x/outs/TwoYear_Tfh_lineages_markers.tsv')
Tfh_cl_markers <- read.delim('./10x/outs/TwoYear_Tfh_lineages_markers.tsv', stringsAsFactors = F)
...
ggsave('./10x/outs/TwoYear_Tfh_lineages_heatmap_markers.pdf', width = 10, height = 8, 
       useDingbats = F)
