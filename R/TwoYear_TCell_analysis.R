...
TMarkers <- read.delim( './10x/outs/TwoYear_Tcell_markers.tsv' , stringsAsFactors = F)
...
ggsave('./10x/outs/TwoYear_heatmap_markers.png', width = 11, height = 11)
...
ggsave('./10x/outs/TwoYear_dotplot_markers.png', width = 10, height = 13)
...
ggsave('./10x/outs/TwoYear_Tcell_factor_cluster_distributions_w_UMAPs.png', plot= dist_big, height = 12, width = 16)

dist <- ( tissue_grp_plt | donor_grp_plt | year_grp_plt | day_grp_plt) 
ggsave('./10x/outs/TwoYear_Tcell_factor_cluster_distributions.png', plot= dist, height = 5, width = 16)
...
ggsave('./10x/outs/TwoYear_Tcell_umaps.pdf', plot = uplots, height = 12, width = 21, useDingbats =F)
ggsave('./10x/outs/TwoYear_Tcell_umaps.png', plot = uplots, height = 12, width = 21)
...
ggsave('./10x/outs/TwoYear_Tcell_feature_plots.png', plot = FPs_panel, height = 5, width = 12)
...
ggsave('./10x/outs/TwoYear_Tcell_figure.png', plot = big_plot, height = 14, width = 16)
